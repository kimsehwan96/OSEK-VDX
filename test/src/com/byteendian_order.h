 ...
 * $System: QPLUS_AUTO.			$
 * $Block: OS/COM.  			$
 * $Module: COM Byte Order  @n	$
 * $Filename: byteendian_order.h	$
 * $Date: 2008.9.12 			$
 * $Rev: ver 1.2 			$
...
#ifndef HEADER_COM_BYTE_ENDIAN_ORDER
#define HEADER_COM_BYTE_ENDIAN_ORDER

#include "struct_type.h"

#endif /* HEADER_COM_BYTE_ENDIAN_ORDER */
