...
#define ICU_MAJOR_VERSION  1
#define ICU_MINOR_VERSION  0
#define ICU_PATCH_VERSION  0
...
##############################################################################*/
extern void Icu_InitPulseAccumulator(icu_ch icu_num);
extern void Icu_GetPulseCount(icu_ch icu_num, UINT8 *pul_cnt);
extern void Icu_ResetCount(icu_ch icu_num);
